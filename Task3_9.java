/* Даны координаты начала и координаты конца отрезка. Если считать отрезок обозначением горки, то в одном случае
* он обозначает спуск, в другом – подъем. Определить и вывести на экран – спуск это или подъем, ровная дорога
* или вообще отвесная.
*/
...
public class Task3_9 {
    public static void main(String[] args) {
        ...
        if (x1 < x2) {
            if ((x1 < x2) & (y1 < y2)) System.out.println("дорога впереди в подъем.");
            if ((x1 < x2) & (y1 > y2)) System.out.println("дорога впереди со спуском.");
        }
        else {
            System.out.println("Кругом! Наперад!");
            if ((x1 > x2) & (y1 < y2)) System.out.println("дорога впереди в подъем.");
            if ((x1 > x2) & (y1 > y2)) System.out.println("дорога впереди со спуском.");
        }
    }
